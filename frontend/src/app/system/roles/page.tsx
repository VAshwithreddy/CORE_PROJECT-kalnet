...
const ROLES = [
  ...
  { id: "role-dept", name: "Department Head", slug: "department_head", description: "Manages team, projects, and assignments within their department.", members: 2, permissions: 4 },
  ...
  { id: "role-wa", name: "Work Admin", slug: "work_admin", description: "Operations and work routing across departments.", members: 1, permissions: 4 },
  { id: "role-sa", name: "System Admin", slug: "system_admin", description: "Full system access including user and permission management.", members: 1, permissions: 7 },
];
