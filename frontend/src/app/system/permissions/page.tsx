...
const rows: PermRow[] = allPerms.map((perm) => ({
  ...
  departmentHead: rolePermissions.department_head.includes(perm as any) ? "✅" : "—",
  executive: rolePermissions.executive.includes(perm as any) ? "✅" : "—",
  workAdmin: rolePermissions.work_admin.includes(perm as any) ? "✅" : "—",
  systemAdmin: rolePermissions.system_admin.includes(perm as any) ? "✅" : "—",
}));

const columns: DataTableColumn<PermRow>[] = [
  { key: "permission", header: "Permission", minWidth: "200px" },
  { key: "employee", header: "Employee" },
  { key: "departmentHead", header: "Department Head" },
